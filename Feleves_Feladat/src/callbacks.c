...
void keyboard(unsigned char key, int x, int y)
{
	...
	case 't':
		...
		break;
	case '+':
		light_ambient[0] = fmod(light_ambient[0] + 0.01f, 1.0f);
		light_ambient[1] = fmod(light_ambient[1] + 0.01f, 1.0f);
		light_ambient[2] = fmod(light_ambient[2] + 0.01f, 1.0f);
		light_ambient[3] = fmod(light_ambient[3] + 0.01f, 1.0f);
